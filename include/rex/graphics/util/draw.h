...
union ResolveEdramInfo {
  ...
  struct {
    ...
    // Flag from gamma_decode_pwl_resolve in resolve shader: full 8_8_8_8_GAMMA
    // resolves decode PWL gamma to linear before MSAA averaging / conversion,
    // then write gamma bytes again for gamma dests (canary d11950528).
