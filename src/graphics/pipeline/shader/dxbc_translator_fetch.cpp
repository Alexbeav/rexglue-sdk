...
void DxbcShaderTranslator::ProcessTextureFetchInstruction(
  ...
  if (instr.opcode == FetchOpcode::kGetTextureWeights) {
    ...
    if (instr.opcode == FetchOpcode::kTextureFetch) {
      ...
      // the guest integer range here (xenia-canary d11950528 + 2ddc5ef73).
      ...
      MarkSystemConstantUsed(SystemConstants::Index::kTextureIntegerScaleBits);
      dxbc::Src integer_scale_bits_packed(GetSystemConstantSrc(
      ...
      // Per lane (6 bits): width = (bits & 0xF) + 1, signed = bit 4,
      // unsigned-biased = bit 5; scale = (1 << (width - signed)) - 1.
      ...
      a_.OpIMAd(integer_scale_dest, integer_scale_flags_src, dxbc::Src::LI(-1), integer_scale_src);
      ...
      a_.OpEndIf();
      // Release integer_scale_bits_temp, integer_scale_temp, integer_scale_flags_temp.
      PopSystemTemp(3);
    }
